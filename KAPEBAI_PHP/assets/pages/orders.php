...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <form method="post" action="process_payment.php" onsubmit="return confirm('Do you really want to make a receipt?');">
        ...
        <button class="calculate-change-btn" type="button" onclick="calculateChange('<?php echo $customerName; ?>')">Calculate Change</button>
...
?>
<script>
    function calculateChange(customerName) {
        // Retrieve tendered amount and total amount
